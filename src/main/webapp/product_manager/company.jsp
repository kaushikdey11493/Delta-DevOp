...
function confirm1(id)
{
	...
	if(!x)
	{
		obj.href="/product_manager/company"; 
	}
}
...
<body>
	...
	<ul>
  	...
  	<br><br>
  	<div class="addbtn" >
	 	<a href="/product_manager/company/add">
	   	Add Company 		
		</a>
	</div>
	<br>
	...
	<br>
  	<table class="compview">
  		...
  		<tr class="row" style="padding:20px">
  			...
  			<td width="9%" class="col"><div class="view"><a href="/product_manager/company/view?id=<%=comp.getCid()%>" style="text-decoration:none;">VIEW</a></div></td>
  			<td width="9%" class="col"><div class="remove"><a id="<%=comp.getCid() %>" href="/product_manager/company/remove?id=<%=comp.getCid()%>" style="text-decoration:none;" onclick="confirm1('<%=comp.getCid()%>')">REMOVE</a></div></td>
  		</tr>
  		<%
  		}
  		%>
